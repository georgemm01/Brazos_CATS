...
process.jec = cms.ESSource("PoolDBESSource",CondDBSetup,
                   connect = cms.string("sqlite:Summer13_V1_MC.db"),
                   toGet =  cms.VPSet(
...
##-------------------- User analyzer  --------------------------------
process.ak5pfl2l3Residual  = cms.EDAnalyzer('FactorizedJetCorrectorDemo',
    levels                   = cms.vstring('L2Relative', 'L3Absolute', 'L2L3Residual'),#, 'L5Flavor_gJ', 'L7Parton_gJ'),
